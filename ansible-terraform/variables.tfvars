...
# 虚拟机名称
vm_name = ["test-terraform-1", "test-terraform-2","test-terraform-3"]

# 集群个节点名称
master_hostnames = [ "test-terraform-1" ]
node_hostnames = [ "test-terraform-2", "test-terraform-3" ]
